...
| 4. 幫你檢查 | `/trip-review` | 自動查 18 項常見錯誤（星期寫錯、景點沒開、轉機來不及、時差沒考慮、費用算錯等），查到就直接修正 |
...
行程排好後自動檢查 18 項（家庭旅行 21 項）：星期有沒有寫錯、景點那天是不是休館、轉機時間夠不夠、跨洲第一天是不是排太滿沒考慮時差、費用有沒有算錯。發現問題直接修正。
