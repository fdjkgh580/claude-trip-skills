...
| 14-30 天 | 立刻辦（急件）/ 兩週前 / 1 週前 / 前一天 / 當天 / 抵達 | 時間緊迫版 |
...
- 插座轉接頭採買（**若目的地電壓與本國不同，電器務必確認支援目的地電壓，否則會燒掉**；例如台灣 110V vs 歐洲 220-230V，吹風機、刮鬍刀這類高瓦數電器最容易出事）
- 隨身現金備齊
- 家庭旅行：確認是否需要另一方家長同意書
...
7. **當地重要句子**（旅行經驗為「第一次出國」才產）— 「我需要醫生/警察」「我的護照不見了」「最近的台灣代表處在哪？」當地語言 + 英文對照
...
顯示清單摘要（每個階段幾個項目 + 距出發天數），告訴使用者檔案存在哪裡。
